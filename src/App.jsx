...
function App() {
  ...
  {
    id: 4,
    description: "Confía en mí, no quiero perderte.",
    img: "https://media.tenor.com/Bn88VELdNI8AAAAi/peach-goma.gif"
  },
  {
    id: 5,
    description: "De verdad no quiero ser mi patito unu andale.",
    img: "https://i.pinimg.com/originals/c6/b3/0d/c6b30d1a2dc178aeb92de63295d4ae64.gif"
  },
  {
    id: 6,
    description: "Se que aun puedo ser tu felicidad.",
  ...
  {
    id: 10,
    description: "Aun quiero ser el amor de tu vida.",
          ...
          <div className="p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-5 items-center">
              ...
              >
                ...
                <span hidden>{document.title = Object.keys(randomValor).length === 0 ? "¿Quieres ser mi San Valentin siempre?" : randomValor.description}</span>
              </button>
            </div>
          </div>
        ) : (
